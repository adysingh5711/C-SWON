      ...
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-6">
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-1">
            ...
            <a
              href="https://adysingh5711.github.io/C-SWON/"
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-md px-3 py-1.5 text-sm font-medium text-[var(--ink-secondary)] transition-all hover:bg-[var(--surface-1)] hover:text-[var(--ink)]"
            >
              Docs
            </a>
          </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="rounded-md p-1.5 text-[var(--ink-tertiary)] transition-colors hover:text-[var(--ink)]"
            aria-label="GitHub"
          >
